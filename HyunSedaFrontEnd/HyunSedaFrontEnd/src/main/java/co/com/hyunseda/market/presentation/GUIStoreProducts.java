...
public class GUIStoreProducts extends javax.swing.JDialog {
    ...
    public GUIStoreProducts(java.awt.Frame parent, boolean modal,ProductService productService,
            CarritoService carritoService, User prmUser, List<Rol> prmUserRole) {
        super(parent, modal);
        this.productService = productService;
        this.carritoService = new CarritoService();
        this.atrUser = prmUser;
        this.atrUserRol = prmUserRole;
        createObservers();
        initComponents();
        initializeTable();
        //loadData();
   ...
   private void loadDataByName(String name) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        }else */if(rdoName.isSelected() && !"".equals(txtSearch.getText()))
        {
