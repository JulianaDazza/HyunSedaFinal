...
public class GUIListProductsCar extends javax.swing.JFrame implements Observer{
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        if(this.payService.findPayByAccount(Integer.parseInt(codigoCuenta)) != null){
            JOptionPane.showMessageDialog(null, "Pago realizado exitosamente", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(null, "wa.me/573147889201", "Link de compra:", JOptionPane.INFORMATION_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(null, "Número de cuenta inválido", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        }
